    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="container-custom mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold font-heading mb-6">Our Story</h1>
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-6">Experience the Now I Can Difference</h2>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/therapy-services/intensive-physical-therapy" 
                className="btn bg-blue-600 text-white hover:bg-blue-700"
              >
                Learn About Our Therapy
              </Link>
              <Link 
