  ...
  const therapists = [
    {
      ...
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/mark-barney.jpg`,
      bio: [
    ...
    },
    {
      ...
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/nacole-jackson.jpg`,
      bio: [
    ...
    },
    {
      ...
      title: 'Doctor of Physical Therapy',
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/megan-merrill.jpg`,
      bio: [
    ...
    },
    {
      ...
      title: 'Doctor of Physical Therapy',
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/david-landeen.jpeg`,
      bio: [
    ...
    },
    {
      ...
      title: 'Doctor of Physical Therapy',
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/brooke-winter.png`,
      bio: [
    ...
    },
    {
      ...
      title: 'Physical Therapist Assistant',
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/ali-barney.jpg`,
      bio: [
    ...
    },
    {
      ...
      title: 'Physical Therapist Assistant',
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/jessica-butler.png`,
      bio: [
    ...
    },
    {
      ...
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/melissa-chalk.jpg`,
      bio: [
    ...
    },
    {
      ...
      location: 'utah',
      image: `${import.meta.env.BASE_URL}/images/tracey-christensen.jpg`,
      bio: [
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/Allison.jpg`,
      bio: [
  ...
  const boardMembers = [
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/joel-tracey-christensen.png`,
    ...
    {
      name: 'LARRY MCFERSON',
      image: `${import.meta.env.BASE_URL}/images/larry-mcferson.png`,
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/john-livingston.png`,
    ...
    {
      name: 'NEIL LEBARON',
      image: `${import.meta.env.BASE_URL}/images/neil-lebaron.png`,
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}/images/rebecca-swindle.png`,
    ...
    {
      name: 'LIZ LIVINGSTON',
      image: `${import.meta.env.BASE_URL}/images/liz-livingston.png`,
                        ...
                        {therapist.image ? (
                          <img 
                            ...
                            onError={(e) => {
                              ...
                              e.target.src = `${import.meta.env.BASE_URL}/images/default-profile.png`; // Fallback image
                            }}
                          />
                        ) : (
                      ...
                      <div>
                        ...
                        {member.image ? (
                          <img 
                            ...
                            onError={(e) => {
                              e.target.onerror = null;
                              e.target.src = `${import.meta.env.BASE_URL}/images/default-board.png`; // Fallback image
                            }}
                          />
                        ) : (
