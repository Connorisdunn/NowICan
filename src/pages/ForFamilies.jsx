    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="container-custom mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link to="/for-families/getting-started" className="card p-6 hover:bg-primary-blue-50">
            <h3 className="text-xl font-bold mb-2">Getting Started</h3>
            <p className="text-gray-600">Learn how to begin therapy services with Now I Can.</p>
          </Link>
          
          <Link to="/for-families/therapy-schedule" className="card p-6 hover:bg-primary-blue-50">
          ...
          <Link to="/for-families/payment-financial-aid" className="card p-6 hover:bg-primary-blue-50">
          ...
          <Link to="/for-families/accommodations" className="card p-6 hover:bg-primary-blue-50">
          ...
          <Link to="/for-families" className="card p-6 hover:bg-primary-blue-50">
          ...
          <Link to="/for-families/faqs" className="card p-6 hover:bg-primary-blue-50">
