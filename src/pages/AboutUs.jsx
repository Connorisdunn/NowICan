    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="container-custom mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link to="/about-us/our-story-mission" className="card p-6 hover:bg-primary-blue-50">
          ...
          <Link to="/about-us/our-team" className="card p-6 hover:bg-primary-blue-50">
            <h3 className="text-xl font-bold mb-2">Our Team</h3>
            <p className="text-gray-600">Meet our dedicated team of therapists.</p>
          </Link>
                    
          <Link to="/about-us/locations" className="card p-6 hover:bg-primary-blue-50">
