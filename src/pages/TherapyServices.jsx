    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="container-custom mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link to="/therapy-services/intensive-physical-therapy" className="card p-6 hover:bg-blue-50">
          ...
          <Link to="/therapy-services/traditional-physical-therapy" className="card p-6 hover:bg-blue-50">
          ...
          <Link to="/therapy-services/who-we-serve" className="card p-6 hover:bg-blue-50">
          ...
          <Link to="/therapy-services/treatment-methods" className="card p-6 hover:bg-blue-50">
          ...
          <Link to="/therapy-services/therapy-schedule" className="card p-6 hover:bg-blue-50">
