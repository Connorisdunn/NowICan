  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-primary-blue-800">Step 1: Patient Information</h3>
      ...
      case 2:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-primary-blue-800">Step 2: Parent/Guardian Information</h3>
            <p className="text-gray-600 mb-6">
      ...
      case 3:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-primary-blue-800">Step 3: Select Location</h3>
            <p className="text-gray-600 mb-6">
              ...
              <div 
                className={`border rounded-lg p-6 cursor-pointer transition-all duration-200 ${
                  formData.location === 'utah' 
                    ...
                    : 'border-gray-200 hover:border-primary-blue-200 hover:bg-primary-blue-50/30'
                }`}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <address className="text-gray-600 not-italic">
                      ...
                      <p>Orem, UT 84058</p>
                      <p className="mt-2">
                        <a href="tel:+18012281935" className="text-primary-blue-600 hover:text-primary-blue-800">(801) 228-1935</a>
                      </p>
                      <p>
                        <a href="mailto:info@nowican.org" className="text-primary-blue-600 hover:text-primary-blue-800">info@nowican.org</a>
                      </p>
                    </address>
                  </div>
                </div>
              ...
              <div 
                className={`border rounded-lg p-6 cursor-pointer transition-all duration-200 ${
                  formData.location === 'pennsylvania' 
                    ? 'border-primary-orange-500 bg-primary-orange-50 shadow-md' 
                    : 'border-gray-200 hover:border-primary-orange-200 hover:bg-primary-orange-50/30'
                }`}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <address className="text-gray-600 not-italic">
                      ...
                      <p>Lititz, PA 17543</p>
                      <p className="mt-2">
                        <a href="tel:+17172695829" className="text-primary-orange-600 hover:text-primary-orange-800">(717) 269-5829</a>
                      </p>
                      <p>
                        <a href="mailto:allison@nowican.org" className="text-primary-orange-600 hover:text-primary-orange-800">allison@nowican.org</a>
                      </p>
                    </address>
                  </div>
                </div>
      ...
      case 4:
        return (
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-primary-blue-800">Step 4: Review & Submit</h3>
            <p className="text-gray-600 mb-6">
            ...
            {[1, 2, 3, 4, 5].map((step) => (
              <div key={step} className="flex flex-col items-center">
                <div className={`
                  ...
                  ${step < currentStep ? 'bg-primary-blue-600' : step === currentStep ? 'bg-primary-blue-500 ring-2 ring-primary-blue-200' : 'bg-gray-200'}
                  ${step <= 4 ? '' : 'bg-primary-orange-500'}
                `}>
                  {step < currentStep ? (
        ...
        <div className="container-custom mx-auto">
          <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8">
            <div className="text-center">
              <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-primary-orange-100 mb-6">
                <svg className="h-8 w-8 text-primary-orange-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="mt-8 bg-primary-blue-50 border border-primary-blue-100 rounded-lg p-6 text-left">
                <h3 className="text-lg font-semibold text-primary-blue-800 mb-3">What happens next?</h3>
                <ol className="space-y-3 text-gray-600">
                  <li className="flex items-start">
                    <span className="flex-shrink-0 flex items-center justify-center h-6 w-6 rounded-full bg-primary-blue-200 text-primary-blue-600 text-sm font-medium mr-3 mt-0.5">1</span>
                    <span>Our intake coordinator will review your information and call you within 1-2 business days.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="flex-shrink-0 flex items-center justify-center h-6 w-6 rounded-full bg-primary-blue-200 text-primary-blue-600 text-sm font-medium mr-3 mt-0.5">2</span>
                    <span>During the call, we'll answer your questions and schedule your free in-person or virtual consultation.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="flex-shrink-0 flex items-center justify-center h-6 w-6 rounded-full bg-primary-blue-200 text-primary-blue-600 text-sm font-medium mr-3 mt-0.5">3</span>
                  ...
                  <li className="flex items-start">
                    <span className="flex-shrink-0 flex items-center justify-center h-6 w-6 rounded-full bg-primary-blue-200 text-primary-blue-600 text-sm font-medium mr-3 mt-0.5">4</span>
              ...
              <div className="mt-8">
                <a href="/" className="btn bg-primary-blue-600 hover:bg-primary-blue-700 text-white py-2 px-6 rounded-md shadow-sm">
                  Return to Homepage
                </a>
              </div>
            </div>
              ...
              <div className="mt-8 flex justify-between">
                ...
                {currentStep < totalSteps ? (
                  <button
                    type="button"
                    onClick={nextStep}
                    className="px-6 py-2 bg-primary-blue-600 text-white rounded-md hover:bg-primary-blue-700 focus:outline-none focus:ring-2 focus:ring-primary-blue-500 focus:ring-offset-2"
                  >
                    Continue
                  </button>
                ) : (
